...
| **M6** | **Modern sentence quality** | Tatoeba BLEU-style bars (src→en); path to FLORES/COMET | WMT leaders: frontier LLMs; EU pairs often DeepL-strong | **Climb live:** BLEU~2.4 · U-F1~34 · B1 es~53 · cov~90% (bigram+phrase+templates, offline, held-out train) | Larger phrase mass · order models · CJK BPE · optional neural student under FSOT law |
