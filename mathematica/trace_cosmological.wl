...
(* domain = cosmological  built = 2026-07-18T13:04:07.544954+00:00 *)
...
FSOTTrace[] := Module[{steps = {}, c, add,
  ...
  S = k*raw; add["S", S];
  Association["domain" -> "cosmological", "S" -> S, "T1" -> t1, "T2" -> t2, "T3" -> t3, "steps" -> steps]
];

(* Python microscope reference panel for cross-check *)
FSOTPythonPanel = <|"S" -> -0.5024559462100433, "T1" -> -2.1956926285882763, "T2" -> 1, "T3" -> 7.8249280651012077e-18|>;
