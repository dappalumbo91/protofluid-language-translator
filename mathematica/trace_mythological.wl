...
(* domain = mythological  built = 2026-07-18T13:04:07.542442+00:00 *)
...
FSOTTrace[] := Module[{steps = {}, c, add,
  ...
  S = k*raw; add["S", S];
  Association["domain" -> "mythological", "S" -> S, "T1" -> t1, "T2" -> t2, "T3" -> t3, "steps" -> steps]
];

(* Python microscope reference panel for cross-check *)
FSOTPythonPanel = <|"S" -> 0.63257833601362834, "T1" -> 0.5053444169211716, "T2" -> 1, "T3" -> 1.1592239677320022e-17|>;
